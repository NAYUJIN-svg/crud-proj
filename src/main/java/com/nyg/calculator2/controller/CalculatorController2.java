package com.nyg.calculator2.controller;
...
import com.nyg.calculator2.dto.CalculationResponse;
import com.nyg.calculator2.service.CalculatorService2;
...
//    --------3. return타입을 dto(record타입)으로 수정해주자
//    --------4. 브라우저확인1: 
//    --------- 브라우저확인2:
	@GetMapping("/add")
...
// ENDpoint테스트 : http://localhost:8010/calculator/calculate
...
//			
//		// 출력 포맷을 결정 결정
//			num1 = 100, num2 = 50 , opration= "ADD", result =150
//					return new CalculationResponse(request.getNum1(), request.getNum2(), result);
//	}
// 	테스트 : http://localhost: 8010/calculator/calculate
//	{
//		"num1":100,
//		"num2":50,
//		"operation" : "*"
